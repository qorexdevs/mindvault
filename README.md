...
| `GET` | `/publishers/:id` | public storefront for vetting a seller: name, wallet, `memberSince`, and a `stats` block (`listed`, `verified`, `totalSales`, `firstListedAt`, `lastListedAt`). No email, earnings or buyer addresses |
